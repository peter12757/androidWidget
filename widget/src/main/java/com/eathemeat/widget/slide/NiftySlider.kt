...
import com.eathemeat.widget.slide.effect.SliderEffect
import kotlin.math.roundToInt

/**
 * @author PeterXi
 * @date 2024/6/30 15:10
 */
class NiftySlider @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    AbsSlider(context, attrs, defStyleAttr) {
    ...
    private var valueChangeListeners: MutableList<(slider: NiftySlider, value: Float, fromUser: Boolean) -> Unit> =
        mutableListOf()
    private var intValueChangeListeners: MutableList<(slider: NiftySlider, value: Int, fromUser: Boolean) -> Unit> =
        mutableListOf()

    private var sliderTouchStartListeners: MutableList<(slider: NiftySlider) -> Unit> =
        mutableListOf()
    private var sliderTouchStopListeners: MutableList<(slider: NiftySlider) -> Unit> =
        mutableListOf()

    private var onProgressAnimEndListener: MutableList<(slider: NiftySlider) -> Unit> =
        mutableListOf()
