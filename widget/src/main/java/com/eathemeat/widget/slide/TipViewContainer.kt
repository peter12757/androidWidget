...
import com.eathemeat.widget.slide.anim.RevealTransition
...
class TipViewContainer @JvmOverloads constructor(
    ...
    private var slider: AbsSlider? = null
...
//        setBackgroundColor(Color.WHITE)
    ...
    fun attachTipView(view: AbsSlider) {
        val contentView = getContentView(view)
        this.slider = view
        contentView?.let {
            val tipView = findViewById<TipViewContainer>(TIP_VIEW_ID)
            if (tipView == null) {
                addView(this)
            }
            isAttached = true
    ...
    private fun executeTransition(){
        ...
        if (customTransition == null){
            ...
            if (customTransition is RevealTransition){
